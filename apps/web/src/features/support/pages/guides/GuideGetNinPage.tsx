        ...
        <section className="mt-8">
          <div className="p-6 bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg text-white">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary-600 font-semibold rounded-lg hover:bg-primary-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary-600 transition-colors"
            >
              Find NIMC Centers
