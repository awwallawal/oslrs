...
describe('AuditService', () => {
  ...
  describe('PII_ACTIONS constants', () => {
    ...
    it('should have exactly 9 action types', () => {
      expect(Object.keys(PII_ACTIONS)).toHaveLength(9);
    });
  ...
  describe('AUDIT_ACTIONS constants', () => {
    ...
    it('should have 52 total action types across all categories', () => {
      ...
      // prep-settings-landing-and-feature-flags added SETTINGS_FLIPPED ('settings.flipped') → 34.
      ...
      // Story 9-61 (authenticated registration edit + session resume) added 3:
      ...
      expect(Object.keys(AUDIT_ACTIONS)).toHaveLength(52);
    });
  });
