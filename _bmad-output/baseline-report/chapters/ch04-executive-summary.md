...
This Baseline Study Report presents the findings and outputs of the pre-fieldwork phase of the engagement (November 2025 – May 2026), covering the establishment of the digital and physical infrastructure, the design and validation of the data collection methodology, and the development of a comprehensive occupational skills taxonomy for Oyo State.
