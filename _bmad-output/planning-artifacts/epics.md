...
- **CI + test-infra hardening (2026-07):** 13-30 reauth-routes test-teardown FK-race helper (done+deployed — shared audit-safe teardown) · 13-31 osv-scanner audit-gate migration (done+deployed — npm retired `pnpm audit`, 410) · 13-32 osv-scanner prod-scope + vuln remediation (done+deployed — two-tier prod/report gate + turbo 1.13→2.x; removed 13-31's 2026-08-15 grandfather-expiry cliff at the root).
