...
- **→ Now authored as Story 9-60** ("Authenticated registration edit + true session resume", Bob/SM 2026-06-19; scope reconciled by John/PM as a standalone Epic 9 post-launch enabler, sequenced before 9-32). This section is 9-60's source-of-truth design; **9-60 closes this story's review findings M1 (magic-link re-entry) + M2 (consent-only edit)** when built. [Source: 9-60-authenticated-registration-edit-and-session-resume.md]
