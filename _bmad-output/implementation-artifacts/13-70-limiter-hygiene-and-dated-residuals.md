...
⭐ **The guard now expires 5 rows on 2026-10-16** — `13-68 R2b`, `13-70 R4`, `R5`, `R6`, `R8` — verified by
adjudication at fixed clocks (**0** on 2026-09-20, **0** on 2026-10-15, **5** on 2026-10-16, **5** on
2027-01-01). ⛔ **R8 was added AT ADJUDICATION and did not fire on its first write**, which is how its own
