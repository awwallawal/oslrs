...
const choices = [
  ...
  // Story 13-16 — values MUST equal lgas.code (apps/api/src/db/seeds/lgas.seed.ts):
  // respondents.lga_id is canonically the slug and every analytics join assumes it.
